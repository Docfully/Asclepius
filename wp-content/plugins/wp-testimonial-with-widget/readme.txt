...
== Description ==
Many CMS site needs to display client's testimonial on their website. WP Testimonial Plugin with Widget allow you to add testimonial from wp-admin side same like you add post, which allows you to display testimonials on your website the easy way.
...
View [DEMO](http://wponlinesupport.com/wp-plugin/wp-testimonial-with-widget/) | [PRO DEMO and Features](http://wponlinesupport.com/wp-plugin/wp-testimonial-with-widget/) for additional information.
