...
function wptww_help_tabs() {
	$wpos_feed_tabs = array(
						...
						'offers-feed' 	=> array(
													'name'				=> __('Hire Us', 'wp-testimonial-with-widget'),
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="http://docs.wponlinesupport.com/wp-testimonials-with-rotator-widget/" target="_blank"><?php _e('Documentation', 'wp-testimonial-with-widget'); ?></a>									
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/wp-testimonial-with-widget/" target="_blank"><?php _e('Go Premium ', 'wp-testimonial-with-widget'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-testimonials-with-rotator-widget/" target="_blank"><?php _e('View PRO Demo ', 'wp-testimonial-with-widget'); ?></a>	</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
								...
								<div class="inside">
									...
									<p><a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/projobs-support/" target="_blank"><?php _e('PRO Support', 'wp-testimonial-with-widget'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p><?php _e('Enjoyed this plugin? You can help by rate this plugin', 'wp-testimonial-with-widget'); ?> <a href="https://wordpress.org/support/plugin/wp-testimonial-with-widget/reviews/" target="_blank"><?php _e('5 stars!', 'wp-testimonial-with-widget'); ?></a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
