<div id="wptww-quote-<?php echo $post->ID;?>" class="<?php echo $css_class.' '.$class;?>">
	...
	<?php if(true == $args['display_client'] && '' !=  $post->testimonial_client || true == $args['display_job'] && '' !=  $post->testimonial_job){?>
		...
		<?php if ( isset( $post->image ) && ( '' != $post->image ) && true == $args['display_avatar'] ){?>  <h4><?php echo $post->post_title?></h4>
