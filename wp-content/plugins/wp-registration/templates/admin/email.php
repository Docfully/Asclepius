...
<div class="container-fluid wpr-email-wrapper">	
	...
	<div class="row">
		...
		<div class="col-md-6">
			<p><?php _e('Provide template for new user. It will be sent to user along with login details. You can use these Vars in message: %USERNAME%, %PASSWORD%, %SITE_NAME%, %SITE_URL%, %LOGIN_URL%, %ADMIN_EMAIL%' , 'wp-registration'); ?></p>	
		</div>
	</div>
